...
<template>
    <div class="gallery-container">
        <div class="gallery">
            <div v-for="index in images" :key="index" class="image-holder" @click="removeImage(index)">
        ...
        <button class="material-button separate-row-bigger" @click="raffle">Raffle!</button>
    </div>
</template>
